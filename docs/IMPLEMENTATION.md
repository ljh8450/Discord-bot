...
- 링커리어 중심의 공모전·교육·대외활동 수집
- 캠퍼스픽·티켓타코·이벤터스 보조 수집
...
- 실밸개발자·AI Frontier Korea·Tech Bridge·미드나잇 로그·조코딩·AgentOS·코딩하는 기술사·코딩애플 YouTube 일반 영상
...
- YouTube: 핵심 8개 채널과 주제 필터를 적용한 선택 2개 채널
