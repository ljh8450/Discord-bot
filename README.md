...
- **변경과 마감도 놓치지 않습니다.** 중요 내용이 바뀌면 업데이트를, 마감 D-3·D-1·당일에는 리마인더를 보냅니다.
...
- 신규 발견, 중요 내용 변경, D-3·D-1·당일 마감 알림
...
- `UPDATED`: 제목·마감일·자격 등 중요 정보 변경
- `DEADLINE_APPROACHING`: D-3, D-1 또는 당일 마감
